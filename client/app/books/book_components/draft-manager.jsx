...
export default function DraftManager({ book, onBack, onSave }) {
  ...
  const getTagColor = (tag) => {
    const colors = {
      ...
      character:
        "bg-purple-100 text-purple-800 border-purple-200 dark:bg-purple-900/20 dark:text-purple-300",
      ...
      inspiration:
        "bg-pink-100 text-pink-800 border-pink-200 dark:bg-pink-900/20 dark:text-pink-300",
    };
    return (
      colors[tag] ||
      "bg-gray-100 text-gray-800 border-gray-200 dark:bg-gray-800/50 dark:text-gray-300"
    );
  };
              ...
              <div>
                ...
                {newDraft.tag === "custom" && (
                  <Input
                    ...
                    onChange={(e) =>
                      setNewDraft({ ...newDraft, customTag: e.target.value })
                    }
              ...
              {!book.drafts || book.drafts.length === 0 ? (
                <div className="text-center py-16">
                  ...
                  <p className="text-muted-foreground">
                    Capture your ideas and scenes as you write
                  </p>
                </div>
              ) : (
