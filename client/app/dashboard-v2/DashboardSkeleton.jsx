    ...
    <PageTransition>
      <div className="min-h-screen text-slate-800 dark:text-slate-200 bg-slate-50 dark:bg-slate-900">
        ...
        <div className="mx-auto max-w-[1600px] 2xl:max-w-[1760px] 3xl:max-w-[1920px] px-2 lg:px-4 xl:px-6 2xl:px-8 3xl:px-10 py-8 2xl:py-12 3xl:py-16">
          ...
          <section className="rounded-2xl bg-white dark:bg-slate-800 shadow-md ring-1 ring-slate-200 dark:ring-slate-700 p-4 sm:p-6 lg:p-8 2xl:p-12 3xl:p-16 mb-6 2xl:mb-8 3xl:mb-12 w-full">
            <div className="grid grid-cols-1 lg:grid-cols-12 xl:grid-cols-12 gap-4 sm:gap-6 lg:gap-8 xl:gap-8 2xl:gap-12 3xl:gap-16">
              <div className="lg:col-span-8 xl:col-span-8">
                <div className="inline-flex items-center gap-2 rounded-full bg-slate-200 dark:bg-slate-700 h-6 w-32 animate-pulse" />
                <div className="mt-2 h-8 sm:h-10 lg:h-12 xl:h-14 2xl:h-16 3xl:h-18 w-64 sm:w-80 lg:w-96 xl:w-[28rem] 2xl:w-[32rem] 3xl:w-[36rem] bg-slate-200 dark:bg-slate-700 rounded animate-pulse" />
                <div className="mt-1 h-6 sm:h-7 2xl:h-8 3xl:h-9 w-48 sm:w-64 2xl:w-80 3xl:w-96 bg-slate-200 dark:bg-slate-700 rounded animate-pulse" />
                <div className="mt-4 sm:mt-5 2xl:mt-8 3xl:mt-10 flex flex-wrap items-center gap-2 sm:gap-3 2xl:gap-4 3xl:gap-6">
                  <div className="h-10 sm:h-12 lg:h-14 2xl:h-16 3xl:h-18 w-32 sm:w-36 lg:w-40 2xl:w-44 3xl:w-48 bg-slate-200 dark:bg-slate-700 rounded-2xl animate-pulse" />
                  <div className="h-10 sm:h-12 lg:h-14 2xl:h-16 3xl:h-18 w-24 sm:w-28 lg:w-32 2xl:w-36 3xl:w-40 bg-slate-200 dark:bg-slate-700 rounded-2xl animate-pulse" />
                  <div className="h-10 sm:h-12 lg:h-14 2xl:h-16 3xl:h-18 w-28 sm:w-32 lg:w-36 2xl:w-40 3xl:w-44 bg-slate-200 dark:bg-slate-700 rounded-2xl animate-pulse" />
                  <div className="h-10 sm:h-12 lg:h-14 2xl:h-16 3xl:h-18 w-32 sm:w-36 lg:w-40 2xl:w-44 3xl:w-48 bg-slate-200 dark:bg-slate-700 rounded-2xl animate-pulse" />
                </div>
              </div>
                ...
                {[
                  ...
                  >
                    ...
                    <div className="text-lg sm:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl 3xl:text-5xl font-semibold text-slate-800 dark:text-slate-200">
                      <div className="h-8 sm:h-10 lg:h-12 xl:h-14 2xl:h-16 3xl:h-18 w-16 sm:w-20 lg:w-24 xl:w-28 2xl:w-32 3xl:w-36 bg-slate-200 dark:bg-slate-700 rounded animate-pulse" />
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="sm:col-span-1 lg:col-span-4 xl:col-span-4 h-full">
                ...
                >
                  <div className="flex flex-col justify-center items-center h-full text-center">
                    <div className="w-full">
                      <div className="h-8 sm:h-10 lg:h-12 2xl:h-14 3xl:h-16 w-16 sm:w-20 lg:w-24 2xl:w-28 3xl:w-32 bg-slate-200 dark:bg-slate-700 rounded animate-pulse mx-auto mb-2" />
                      <div className="text-sm 2xl:text-base 3xl:text-lg text-slate-500 dark:text-slate-400 mb-3">
                        days
                      </div>
                        ...
                        {["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map(
                          (day, index) => (
                            ...
                            >
                              ...
                              <div className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 2xl:w-8 2xl:h-8 3xl:w-10 3xl:h-10 rounded-full bg-slate-200 dark:bg-slate-700 animate-pulse" />
                            </div>
                          )
                        )}
                      </div>

                      <div className="text-xs sm:text-sm 2xl:text-base 3xl:text-lg text-slate-500 dark:text-slate-400 mb-4 px-2">
                        Keep it going with a 5‑min sprint
                      </div>
                      <div className="w-full max-w-32 2xl:max-w-40 3xl:max-w-48 mx-auto h-8 sm:h-10 2xl:h-12 3xl:h-14 bg-slate-200 dark:bg-slate-700 rounded-xl animate-pulse" />
                    </div>
                  </div>
                </Card>
              </div>
              ...
              <Card title="Upcoming Tasks" actionLabel="Manage all tasks">
                <div className="flex flex-wrap gap-2 2xl:gap-3 3xl:gap-4 mb-4">
                  {[
                    ...
                    <div
                      key={t}
                      className="rounded-full bg-slate-200 dark:bg-slate-700 h-8 sm:h-10 2xl:h-12 3xl:h-14 px-3 sm:px-4 2xl:px-5 3xl:px-6 animate-pulse"
                      style={{ width: `${t.length * 0.8}rem` }}
                    />
                  ))}
                </div>
                <div className="flex flex-col sm:flex-row gap-2 2xl:gap-3 3xl:gap-4">
                  <div className="flex-1 h-12 sm:h-14 2xl:h-16 3xl:h-18 bg-slate-200 dark:bg-slate-700 rounded-xl animate-pulse" />
                  <div className="h-12 sm:h-14 2xl:h-16 3xl:h-18 w-20 sm:w-24 2xl:w-28 3xl:w-32 bg-slate-200 dark:bg-slate-700 rounded-xl animate-pulse sm:whitespace-nowrap" />
                </div>
              </Card>
            </div>
          ...
          <section className="mt-8 2xl:mt-12 3xl:mt-16 text-center text-xs 2xl:text-sm 3xl:text-base text-slate-500 dark:text-slate-400 w-full">
            <span>
...
function Card({ title, actionLabel, children, className }) {
  return (
    <div
      className={`rounded-2xl bg-white dark:bg-slate-800 shadow-sm ring-1 ring-slate-200 dark:ring-slate-700 p-4 lg:p-5 xl:p-6 2xl:p-8 3xl:p-10 ${className}`}
    >
      <div className="mb-4 2xl:mb-6 3xl:mb-8 flex items-center justify-between">
        ...
        {actionLabel && (
          <button className="text-sm 2xl:text-base 3xl:text-lg text-[#0F1A2E] dark:text-slate-300 hover:opacity-80">
            {actionLabel} →
          </button>
        )}
      </div>
