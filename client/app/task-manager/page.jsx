  ...
  return (
    <>
      ...
      <div className="pointer-events-none fixed -z-10 inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-96 w-96 rounded-full bg-gradient-to-br from-amber-200 to-orange-200 blur-3xl opacity-30" />
      </div>
